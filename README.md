...
- **Chart** — infinite scroll (lazy-loads older candles as you scroll left); circle B/S fill markers on the chart (Hyperliquid/Based.one style) with hover tooltip showing trade details (e.g. "Open Long at 91.756")
