...
- **Chart** — infinite scroll (lazy-loads older candles as you scroll left); custom HTML circle markers with "B"/"S" text centered inside (Hyperliquid style), positioned at exact fill price via timeToCoordinate/priceToCoordinate; hover tooltip showing trade details (e.g. "Open Long at 91.756"); fills fetched from both main and xyz dexes so HIP-3 trade markers appear
