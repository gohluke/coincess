  ...
  return (
    <BlogPostLayout post={post}>
      ...
      <div className="not-prose my-10">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-[#7C3AED] mb-2">Step 1</div>
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-[#7C3AED] mb-2">Step 2</div>
          ...
          <div className="text-center">
            ...
            <div className="text-3xl font-bold text-[#7C3AED] mb-2">Step 3</div>
      ...
      <div className="not-prose mt-12 space-y-4">
        ...
        >
          <div>
            <h4 className="font-bold text-gray-900 group-hover:text-[#7C3AED]">Hot vs Cold Wallets</h4>
