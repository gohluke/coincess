    ...
    <div className="min-h-screen bg-[#0b0e11] text-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/automate/create" className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-brand hover:bg-brand-hover text-white text-xs font-medium transition-colors">
        ...
        {previews.length === 0 ? (
          <div className="text-center py-12 border border-dashed border-[#2a2e3e] rounded-xl">
            ...
            <Link href="/automate/create" className="text-sm text-brand hover:underline">Set up a copy trading bot</Link>
          </div>
        ) : (
