...
export function AlertBanner() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[100] flex flex-col gap-2 max-w-sm">
      {toasts.map((toast) => (
        <div key={toast.id} className="bg-[#141620] border border-[#7C3AED]/50 rounded-xl p-4 shadow-lg shadow-[#7C3AED]/10 animate-in slide-in-from-bottom-2">
          <div className="flex items-start gap-3">
            <Bell className="h-4 w-4 text-[#7C3AED] shrink-0 mt-0.5" />
