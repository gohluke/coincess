        ...
        <div className="flex flex-col sm:flex-row gap-2 mb-4">
          ...
          <div className="flex-1 flex gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 bg-brand hover:bg-brand-hover disabled:opacity-40 rounded-lg text-xs font-semibold text-white transition-colors"
            >
