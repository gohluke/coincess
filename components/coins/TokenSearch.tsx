    ...
    <div ref={containerRef} className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-[#141620] border border-[#2a2e3e] rounded-xl pl-10 pr-10 py-3 text-sm text-white placeholder:text-[#848e9c] focus:outline-none focus:border-[#7C3AED] transition-colors"
        />
