          ...
          <div className="bg-[#0b0e17] rounded-lg p-3 space-y-2 animate-in slide-in-from-top-2 duration-200">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-7 pr-3 py-2 bg-[#141620] border border-[#2a2e3e] rounded-lg text-sm text-white placeholder-[#4a4e5c] focus:outline-none focus:border-[#7C3AED]/50"
              />
            </div>
