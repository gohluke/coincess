  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-9 pr-9 py-2.5 bg-[#141620] border border-[#2a2e3e] rounded-xl text-sm text-white placeholder-[#848e9c] focus:outline-none focus:border-[#7C3AED]/50 transition-colors"
      />
      {(value || searchQuery) && (
        <button
          onClick={handleClear}
